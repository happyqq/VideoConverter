Attribute VB_Name = "modNetAccess"
...
'        lPos1 = InStr(1, sServerHeader, vbCrLf & "Location: http", vbTextCompare)
'        If lPos1 > 0 Then
'            lPos1 = lPos1 + 12
'            lPos2 = InStr(lPos1, sServerHeader, vbCrLf)
'            If lPos2 > 0 Then
'                WinInetReadEx = "Redirect:" & Mid(sServerHeader, lPos1, lPos2 - lPos1)
'            End If
'        End If
'    End If
'    ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Public Function DownloadFromWeb(ByVal strUrl As String, ByVal sSaveFilePathName As String) As Long
    On Error Resume Next
    DownloadFromWeb = False
    'Kill sSaveFilePathName
    ...
    If FileExists(sSaveFilePathName) Then DownloadFromWeb = True
